...
struct iperf_test
{
    ...
    char      *rl_hostname;
    int	      rl_port;
    int	      reverse_listen;			/* The server actively connects back to client/splicer */
#endif
...
#if defined(IPERF_LITE)
    int	      fd_reserve; 
    int	      send_streams_accepted;
    int	      rec_streams_accepted;
...
#if defined(IPERF_LITE)
extern int IPERF_LITE_START_SIGNAL;
#endif
