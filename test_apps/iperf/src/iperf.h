...
//    struct iperf_stream *streams;               /* pointer to list of struct stream */
    ...
    int				debug_payload;
#ifdef SOMIGRATION
    char			*somig_primary_hostname;
    char			*somig_replica_hostname;
    int				somig_ctl_port;
    enum somig_mode		somig_appmode;
    int				somig_migration;
    int				somig_execute_kernel;
    int				yell_period;
#endif
};
...
/* default settings */
#ifdef SOMIGRATION
#define SOMIG_PRIMARY_HOSTNAME		"172.16.0.2"
#define SOMIG_REPLICA_HOSTNAME		"172.16.0.3"
#define SOMIG_CTL_PORT			9124
#define SOMIG_MODE			CLIENT
#endif
